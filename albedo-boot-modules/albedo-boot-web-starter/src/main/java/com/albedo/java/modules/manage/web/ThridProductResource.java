...
import com.albedo.java.util.HttpClient;
 ...
 */
@Controller
@RequestMapping(value = "${albedo.adminPath}/manage/thirdproduct")
public class ThridProductResource extends DataVoResource<ProductService, ProductVo> {

    public ThridProductResource(ProductService service) {
        super(service);
    }
