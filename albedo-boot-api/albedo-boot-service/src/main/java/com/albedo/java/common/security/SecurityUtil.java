...
public final class SecurityUtil {
    ...
    public static User getByLoginId(final String loginId) {
        User user = JedisUtil.getJson(USER_CACHE, USER_CACHE_LOGIN_NAME_ + loginId, User.class);//从redis缓存取user信息
     ...
     * @return
     */
    public static List<QueryCondition> thirdApiFilter(String loginId){
        String userId=getByLoginId(loginId)==null?"":getByLoginId(loginId).getId();
        if(StringUtil.isBlank(userId)){
            userId=getCurrentUserId();
        }
        List<QueryCondition> list=dataScopeFilter(userId,"creator.org","creator",false);
        return list;
    }
     ...
     * @return
     */
    public static String getReqUserId(String loginId){
